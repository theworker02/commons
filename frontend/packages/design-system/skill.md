...
> Delivery copy of the canonical [`packages/design-system/skill.md`](../../../packages/design-system/skill.md). Update the canonical package guide first, then keep this browser-served copy identical.
